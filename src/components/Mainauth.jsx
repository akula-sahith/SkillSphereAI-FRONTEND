      ...
      <div className="max-w-6xl mx-auto px-6 py-8">
        <div className="grid lg:grid-cols-2 gap-8 relative">
          ...
          >
            ...
            <div className="space-y-4 pt-4">
              ...
              <div className="space-y-1">
                ...
                <button className="text-[#2947A9] hover:text-[#1e3a8a] font-medium hover:underline transition-all duration-200 text-sm">
                  Sign up.
                </button>
              </div>
            </div>
            ...
            <div className="flex justify-center space-x-3 pt-6">
              <div className="p-3 bg-[#2947A9]/10 rounded-full">
          ...
          >
            ...
            <div className="space-y-4 pt-4">
              ...
              <div className="space-y-1">
                ...
                <div className="space-x-1 text-sm">
                  <button className="text-[#0B267D] hover:text-[#1e3a8a] font-medium hover:underline transition-all duration-200">
                    Contact sales
                  </button>
            ...
            {/* Mentor Icons */}
            <div className="flex justify-center space-x-3 pt-6">
              <div className="p-3 bg-[#0B267D]/10 rounded-full">
